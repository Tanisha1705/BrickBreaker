...
public class Board extends JPanel implements Runnable, Constants {
	...
	public Board(int width, int height) {
		...
		withSound = JOptionPane.showOptionDialog(null, "\n\nJAVA PROJECT\n\n Brick Breaker, By:\n\nSudarshan S 1BM17CS105\nSiddharth M 1BM17CS102\nTanisha N 1BM17CS111\nSiddhant Sud 1BM17CS103\n\n" +
				" Controls\n    Enter: Start game, Pause/Resume while in game.\n    Left/Right arrow keys: Move paddle\nItems\n " +
				"   Green Item: Expand paddle\n    Red Item: Shrink paddle\nScoring\n    Block: 50 points\n    Level-up: 100 points\n " +
				"   Life Loss: -100 points\n\n\n ", "About", 0, 0, null, options, options[0]);
	...
	public void paintComponent(Graphics g) {
		...
		if (lives == MIN_LIVES) {
			...
			g.drawString("Game Over!\n LEADERBOARDS: ", getWidth()/5, 50);
			try {
				printScores(g);
			} catch (IOException ioe) {
				ioe.printStackTrace();
			}
			g.drawString("Press the Enter twice to play again.", getWidth()/5, getHeight()-20);
		}
	}
	...
	//Generate random players for leader board
